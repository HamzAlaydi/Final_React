...
export default function AdminStduents() {
    ...
    <AdminLayout>
        ...
        marginTop:"20px"}}>
            <Typography sx={{fontSize:"20px",fontWeight:"500"}}>{t('students')}</Typography>
        </Box>
        {
        !isLoading?
                    ...
                    <TableBody>
                        ...
                        .map((row) => {
                            return <TableRow hover role="checkbox"  key={row.id+"demj"}>
                                ...
                                <TableCell align='center'>
                                    <Button onClick={()=>navigate(`/admin/student/${row.id}/payment`)} sx={{minWidth:"10px"}}><LocalAtmIcon/></Button>
                                </TableCell>
                                <TableCell align='center'>
                                    {row?.wallet}
                                </TableCell>
