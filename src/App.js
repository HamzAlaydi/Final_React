      ...
      <QueryClientProvider client={queryClient}>
        <ThemeProvider theme={theme}>
          <Routes>
            ...
            <Route path='/book/:teacherId' element={student?<DetailsBook/>:<Navigate to="/login"/>}/>
            <Route path='/pay-now' element={student?<PayNow/>:<Navigate to="/login"/>}/>
            <Route path='/student/payment-history' element={student?<StudentPaymentHistory/>:<Navigate to="/login"/>}/>
            ...
            <Route path='teacher/lessons' element={teacher?<TeacherLessons/>:<Navigate to="/login"/>}/>
            <Route path='teacher/notifications' element={teacher?<TeacherNotifications/>:<Navigate to="/login"/>}/>
            <Route path='teacher/credit' element={teacher?<TeacherCredit/>:<Navigate to="/login"/>}/>
            ...
            <Route path='admin/booked-lessons' element={admin?<AdminBookedLessons/>:<Navigate to="/admin/login"/>}/>
            <Route path='admin/payments' element={admin?<AdminPayments/>:<Navigate to="/admin/login"/>}/>
            ...
            <Route path='parent-dash/student/:id' element={parent?<ParentStudent/>:<Navigate to="/"/>}/>
